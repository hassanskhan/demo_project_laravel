...
@endif
            ...
            <h1 class="text-lg mt-5">Edit Post</h1>
            <hr>
            <form action="" method="post">
                @csrf
                <div class="mt-3 w-10">
                    <label for="">Title</label>
                    <input type="text" name="title" class="w-36 rounded-lg " placeholder="Enter Title" value="{{$edit['title']}}">
                </div>
                <div class="mt-3 w-10">
                    <label for="">Description</label>
                    <textarea name="description" class="rounded-lg h-20" id="" cols="30" rows="10"
                        placeholder="Write Description">{{$edit['description']}}</textarea>
                </div>
